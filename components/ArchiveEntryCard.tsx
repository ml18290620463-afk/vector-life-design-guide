...
export const ArchiveEntryCard: React.FC<ArchiveEntryCardProps> = ({
  ...
  if (isListView) {
    return (
      <motion.div
        ...
        onClick={handleClick}
        className="archive-past-entry archive-past-entry--list flex items-stretch group/container"
      >
  ...
  return (
    <motion.div
      ...
      onClick={handleClick}
      className={`archive-past-entry archive-past-entry--grid border p-4 transition-all cursor-pointer group/item relative overflow-hidden rounded-sm ${
        isTimeLocked
          ? theme === 'light'
