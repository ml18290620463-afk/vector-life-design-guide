                          ...
                          {calibrationRequirements.map((req, index) => {
                            ...
                            return (
                              <motion.div
                                ...
                                data-current={isCurrentRequirement ? 'true' : 'false'}
                                title={
                                  index === 0
                                    ? language === 'zh'
                                      ? '8位及以上'
