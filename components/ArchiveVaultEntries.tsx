...
export const ArchiveVaultEntries: React.FC<ArchiveVaultEntriesProps> = ({
  ...
  return (
    <div className="archive-past-timeline space-y-8">
      {groupKeys.map((key, keyIndex) => {
        ...
        return (
          <div
            key={key}
            className="archive-past-group relative animate-in slide-in-from-bottom-4 fade-in duration-700"
          ...
          >
            ...
            <button
              ...
              className="archive-past-group-toggle relative z-10 flex items-center gap-4 w-full text-left group mb-4"
            >
              <div
            ...
            <AnimatePresence>
              {isExpanded && (
                <motion.div
                  ...
                  className="archive-past-group-body overflow-hidden pl-14"
                >
                  <div
                    className={
                      isListView
